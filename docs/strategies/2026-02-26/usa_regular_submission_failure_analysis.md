...
- Generated At: 2026-02-26 16:18:02
...
- `FAIL=OLD_SIMULATION; PENDING=SELF_CORRELATION,PROD_CORRELATION,POWER_POOL_CORRELATION`: 3
...
- `2026-02-26 16:14:32` alpha `E5Ykg6br` phase=`check` reason=`HTTP 429: {"detail":"THROTTLED"}`
- `2026-02-26 16:14:27` alpha `RRqd2Ead` phase=`check` reason=`HTTP 429: {"detail":"THROTTLED"}`
- `2026-02-26 16:14:26` alpha `2rQJap95` phase=`check` reason=`HTTP 429: {"detail":"THROTTLED"}`
- `2026-02-26 16:14:10` alpha `akMoAEQ1` phase=`check` reason=`PENDING=CHECK_TIMEOUT`
- `2026-02-26 16:12:12` alpha `qMvgPrZV` phase=`check` reason=`FAIL=SELF_CORRELATION; PENDING=PROD_CORRELATION`
- `2026-02-26 16:09:17` alpha `N1kwd66o` phase=`check` reason=`FAIL=LOW_SHARPE,LOW_FITNESS,CONCENTRATED_WEIGHT,LOW_SUB_UNIVERSE_SHARPE,OLD_SIMULATION,LOW_2Y_SHARPE; PENDING=SELF_CORRELATION,PROD_CORRELATION`
- `2026-02-26 16:09:15` alpha `pM83rlv` phase=`check` reason=`FAIL=LOW_SHARPE,LOW_FITNESS,CONCENTRATED_WEIGHT,LOW_SUB_UNIVERSE_SHARPE,OLD_SIMULATION,LOW_2Y_SHARPE; PENDING=SELF_CORRELATION,PROD_CORRELATION`
- `2026-02-26 16:09:14` alpha `vRnaMqjw` phase=`check` reason=`FAIL=LOW_SHARPE,LOW_FITNESS,LOW_SUB_UNIVERSE_SHARPE,LOW_2Y_SHARPE; PENDING=SELF_CORRELATION,PROD_CORRELATION`
- `2026-02-26 16:09:08` alpha `oJYRaLn` phase=`check` reason=`FAIL=LOW_SHARPE,LOW_FITNESS,CONCENTRATED_WEIGHT,LOW_SUB_UNIVERSE_SHARPE,OLD_SIMULATION,LOW_2Y_SHARPE; PENDING=SELF_CORRELATION,PROD_CORRELATION`
- `2026-02-26 16:09:02` alpha `780KNoAv` phase=`check` reason=`FAIL=LOW_SHARPE,LOW_FITNESS,IS_LADDER_SHARPE; PENDING=SELF_CORRELATION,PROD_CORRELATION`
- `2026-02-26 16:08:57` alpha `ne3Lv7x` phase=`check` reason=`FAIL=LOW_SHARPE,LOW_FITNESS,CONCENTRATED_WEIGHT,OLD_SIMULATION,LOW_2Y_SHARPE; PENDING=SELF_CORRELATION,PROD_CORRELATION`
